...
class KNN:
    ...
    def find_optimal_k(x: np.ndarray | cp.ndarray,
        ...
        for k in range(1, max_k + 1):
            ...
            y_pred = KNN.predict(x_train, y_train, x_test, k, device)
            acc = accuracy(y_test, y_pred, device)
